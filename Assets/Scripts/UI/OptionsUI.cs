...
public class OptionsUI : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        soundEffectSlider.onValueChanged.AddListener(
            (v) =>
            {
    ...
    private void UpdateTextVisualBindings()
    {
        ...
        interactAltText.text = GameInput.Instance.GetBindingText(
            GameInput.Binding.InteractAlternate
        );
        pauseText.text = GameInput.Instance.GetBindingText(GameInput.Binding.Pause);
        gamePadInteractText.text = GameInput.Instance.GetBindingText(
